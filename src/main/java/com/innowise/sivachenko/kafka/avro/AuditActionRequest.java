...
public class AuditActionRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 664716230876364992L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AuditActionRequest\",\"namespace\":\"com.innowise.sivachenko.kafka.avro\",\"fields\":[{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"@Email\"},{\"name\":\"actionType\",\"type\":{\"type\":\"enum\",\"name\":\"AuditActionType\",\"symbols\":[\"GET\",\"POST\",\"UPDATE\",\"DELETE\"]},\"doc\":\"@NotBlank\"},{\"name\":\"serviceType\",\"type\":{\"type\":\"enum\",\"name\":\"AuditServiceType\",\"symbols\":[\"CLIENT\",\"CAR\",\"RENT\",\"PAYMENT\",\"NOTIFICATION\",\"AUDIT\"]},\"doc\":\"@NotBlank\"},{\"name\":\"actionStatus\",\"type\":\"int\",\"doc\":\"@NotNull\"},{\"name\":\"actionTime\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"},\"doc\":\"@NotNull\"}]}");
  ...
  private static final BinaryMessageEncoder<AuditActionRequest> ENCODER =
      new BinaryMessageEncoder<AuditActionRequest>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AuditActionRequest> DECODER =
      new BinaryMessageDecoder<AuditActionRequest>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<AuditActionRequest> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AuditActionRequest>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public AuditActionRequest(java.lang.String email, com.innowise.sivachenko.kafka.avro.AuditActionType actionType, com.innowise.sivachenko.kafka.avro.AuditServiceType serviceType, java.lang.Integer actionStatus, java.time.Instant actionTime) {
    this.email = email;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 3: return actionStatus;
    case 4: return actionTime;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: actionType = (com.innowise.sivachenko.kafka.avro.AuditActionType)value$; break;
    case 2: serviceType = (com.innowise.sivachenko.kafka.avro.AuditServiceType)value$; break;
    case 3: actionStatus = (java.lang.Integer)value$; break;
    case 4: actionTime = (java.time.Instant)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AuditActionRequest>
    ...
    private Builder(com.innowise.sivachenko.kafka.avro.AuditActionRequest.Builder other) {
      ...
      if (isValidValue(fields()[2], other.serviceType)) {
        this.serviceType = data().deepCopy(fields()[2].schema(), other.serviceType);
        fieldSetFlags()[2] = other.fieldSetFlags()[2];
      }
      if (isValidValue(fields()[3], other.actionStatus)) {
        this.actionStatus = data().deepCopy(fields()[3].schema(), other.actionStatus);
        fieldSetFlags()[3] = other.fieldSetFlags()[3];
      }
      if (isValidValue(fields()[4], other.actionTime)) {
        this.actionTime = data().deepCopy(fields()[4].schema(), other.actionTime);
    ...
    public AuditActionRequest build() {
      try {
        ...
        record.actionType = fieldSetFlags()[1] ? this.actionType : (com.innowise.sivachenko.kafka.avro.AuditActionType) defaultValue(fields()[1]);
        record.serviceType = fieldSetFlags()[2] ? this.serviceType : (com.innowise.sivachenko.kafka.avro.AuditServiceType) defaultValue(fields()[2]);
        record.actionStatus = fieldSetFlags()[3] ? this.actionStatus : (java.lang.Integer) defaultValue(fields()[3]);
        record.actionTime = fieldSetFlags()[4] ? this.actionTime : (java.time.Instant) defaultValue(fields()[4]);
        return record;
